...
\subsection{FFT}
\input{./algorithms/fast-fourier-transform/text.tex}

\subsection{Z-function}
\input{./algorithms/z-function/text.tex}

\subsection{Fast Exponentiation}
\input{./algorithms/fastpow/text.tex}


\section{Data Structures}

\subsection{Fenwick Tree}
\input{./data-structures/fenwick-tree/text.tex}

\subsection{Segment Tree}
\input{./data-structures/segment-tree/text.tex}


\section{Math}

\subsection{Correct Bracket Sequences}
\input{./math/correct-bracket-sequences/text.tex}

\subsection{Polynomial Shift}
\input{./math/polynomial-shift/text.tex}


\section{Graphs}

\subsection{DFS Trees}
\input{./graphs/dfs-trees/text.tex}

\subsection{Least Common Ancestor}
\input{./graphs/least-common-ancestor/text.tex}
